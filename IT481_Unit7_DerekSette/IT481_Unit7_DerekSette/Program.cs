...
namespace IT481_Unit7_DerekSette
{
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Array.Copy(newSmallArray, 0, newSmallArray, 0, newSmallArray.Length);
        ...
        private static int[] onlyUniqueElements(int[] intputArray)
        {

            HashSet<int> set = new HashSet<int>(); 


            int[] tmp = new int[intputArray.Length];
            int index = 0;

            foreach (int i in intputArray)
                if (set.Add(i))
                    tmp[index++] = i;
